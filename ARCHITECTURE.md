...
- **Markets with data**: HR (deep), SI/AT/DE (IKEA + JYSK depth). IT/FI/PL/CZ/HU/RO/SE/DK exist in
  `Markets` but have **no catalog** → empty plan. JYSK/IKEA verified per market (prices differ per
