  ...
  return (
    <span className={className ? `brand-mark ${className}` : 'brand-mark'} aria-hidden="true">
      <svg viewBox="0 0 32 32" width="22" height="22" fill="none" aria-hidden="true" focusable="false">
        ...
        <path d="M5 22.8 H27" stroke="#F3EDE4" strokeWidth="1.6" strokeLinecap="round" opacity="0.8" />
        {/* thin splayed legs — lifts it off the floor (mid-century stance) */}
        <g stroke="#A96849" strokeWidth="1.7" strokeLinecap="round">
        ...
        <rect x="8" y="8" width="16" height="6" rx="2.2" fill="#A96849" />
        <rect x="8" y="14" width="16" height="5" rx="2" fill="#A96849" />
        {/* track arms */}
        <rect x="5.5" y="11.5" width="3" height="7" rx="1.5" fill="#A96849" />
        <rect x="23.5" y="11.5" width="3" height="7" rx="1.5" fill="#A96849" />
        {/* cushion seams: a "+" that reads the body as two back + two seat cushions */}
        <g stroke="#1D1A16" strokeWidth="1" strokeLinecap="round">
          <path d="M9 14 H23" />
