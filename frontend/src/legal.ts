  ...
  privacy: {
    ...
    sections: [
      ...
      { heading: 'Koje podatke obrađujemo i zašto', body: [
        ...
        'E-mail za obavijest o padu cijene (Price Watch) — samo uz tvoju izričitu privolu; e-mail za listu čekanja — ako ga sam ostaviš.',
      ] },
      { heading: 'Pravna osnova (čl. 6 GDPR)', body: [
        ...
        'Privola (čl. 6(1)(a)): Google Analytics te e-mail za obavijest o padu cijene. Privolu možeš povući u svakom trenutku.',
      ] },
      ...
      { heading: 'Koliko dugo čuvamo podatke', body: [
        ...
        'E-mail za Price Watch: dok se ne odjaviš ili ne obrišeš račun.',
      ...
      { heading: 'Tvoja prava i kako ih ostvariti', body: [
        ...
        'Račun i sve povezane podatke možeš obrisati odmah u aplikaciji („Obriši račun"): brišu se račun, spremljeni planovi, zapisi o AI korištenju te Price Watch i lista čekanja vezani uz tvoj e-mail. U privremenim tehničkim zapisima kratko može ostati stavka; Stripe (ako se ikad uvede) i Sentry čuvaju podatke prema svojim uvjetima.',
  ...
  privacy: {
    ...
    sections: [
      ...
      { heading: 'What we process and why', body: [
        ...
        'The price-drop alert email (Price Watch) — only with your explicit consent; a waitlist email — only if you choose to leave one.',
      ] },
      { heading: 'Legal basis (Art. 6 GDPR)', body: [
        ...
        'Consent (Art. 6(1)(a)): Google Analytics and the price-drop alert email. You can withdraw consent at any time.',
      ] },
      { heading: 'Google Analytics', body: [
      ...
      { heading: 'How long we keep data', body: [
        ...
        'Price Watch email: until you unsubscribe or delete your account.',
      ...
      { heading: 'Your rights and how to use them', body: [
        ...
        'You can delete your account and all related data immediately in the app ("Delete account"): this erases your account, saved plans, AI usage records, and the Price Watch and waitlist entries tied to your email. A transient technical log may briefly retain an entry; Stripe (if ever introduced) and Sentry keep data under their own terms.',
  ...
  privacy: {
    ...
    sections: [
      ...
      { heading: 'Welche Daten wir verarbeiten und warum', body: [
        ...
        'Die E-Mail für Preis-Alarm (Price Watch) — nur mit Ihrer ausdrücklichen Einwilligung; eine Warteliste-E-Mail — nur wenn Sie sie hinterlassen.',
      ] },
      { heading: 'Rechtsgrundlage (Art. 6 DSGVO)', body: [
        ...
        'Einwilligung (Art. 6 Abs. 1 lit. a): Google Analytics und die Preis-Alarm-E-Mail. Sie können die Einwilligung jederzeit widerrufen.',
      ] },
      { heading: 'Google Analytics', body: [
      ...
      { heading: 'Wie lange wir Daten speichern', body: [
        ...
        'Price-Watch-E-Mail: bis Sie sich abmelden oder Ihr Konto löschen.',
      ...
      { heading: 'Ihre Rechte und wie Sie sie ausüben', body: [
        ...
        'Sie können Ihr Konto und alle zugehörigen Daten sofort in der App löschen („Konto löschen"): gelöscht werden Ihr Konto, gespeicherte Pläne, KI-Nutzungsdaten sowie die mit Ihrer E-Mail verknüpften Price-Watch- und Warteliste-Einträge. Ein vorübergehendes technisches Protokoll kann kurz einen Eintrag behalten; Stripe (falls je eingeführt) und Sentry speichern Daten gemäß ihren eigenen Bedingungen.',
