...
| `ANTHROPIC_API_KEY` | only if LLM enabled | (none) | Anthropic key for the design assistant (or `BUDGETSPACE_DESIGN_ASSISTANT_API_KEY`); without it the assistant stays rule-based |
